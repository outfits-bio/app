...
export const NotificationsMenu = ({ unreadCount }: NotificationsMenuProps) => {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left z-50">
            ...
            >
                <Menu.Items className="absolute right-1 rounded-xl divide-y divide-stroke mt-1 origin-top-right border border-stroke bg-white dark:bg-black shadow-dropdown p-4 w-[400px] divide-none">
