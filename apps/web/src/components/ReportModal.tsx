            ...
            <Dialog as="div" className="relative z-10" open={isOpen} onClose={() => setIsOpen(false)}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-96 gap-2 flex flex-col overflow-hidden rounded-md dark:text-white bg-white dark:bg-black border dark:border-white p-4 text-left align-middle shadow-xl transition-all">
                                ...
                                <form onSubmit={handleSubmit(handleReportSubmit)}>
                                    <div className="mb-4">
                                        ...
                                        <textarea
                                            id="reason"
                                            className="w-full px-4 py-2 border rounded-md border dark:border-white dark:text-white dark:bg-black"
