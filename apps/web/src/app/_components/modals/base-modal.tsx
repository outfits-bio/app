...
const variants = cva('w-96 gap-2 overflow-hidden rounded-md bg-white dark:bg-black border border-stroke p-4 text-left align-middle shadow-xl transition-all z-10', {
    variants: {
        size: {
            sm: 'w-96',
            md: 'w-128',
