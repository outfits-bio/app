...
const variants = cva('absolute right-1 rounded-lg divide-y divide-stroke mt-1 w-56 origin-top-right border border-stroke bg-white dark:bg-black shadow-dropdown p-4');
