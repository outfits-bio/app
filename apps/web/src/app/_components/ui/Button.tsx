...
const variants = cva('font-semibold font-clash self-stretch h-12 md:h-9 py-2 gap-3 flex items-center', {
    variants: {
        variant: {
            ...
            outline: 'md:bg-gray border dark:border-white disabled:bg-hover bg-transparent hover:bg-hover transform transition duration-100 ease-in-out active:scale-[99%]',
