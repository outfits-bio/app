...
const variants = cva('font-semibold font-clash self-stretch h-12 max-[425px]:h-9 py-2 gap-3 flex items-center', {
    variants: {
        variant: {
            ...
            outline: 'max-[425px]:bg-zinc-400 border dark:border-white disabled:bg-hover bg-transparent hover:bg-hover transform transition duration-100 ease-in-out active:scale-[99%]',
