...
export function RegisterBanner() {
    ...
    if (!session) {
        return (
            <div className="bg-white dark:bg-black hidden flex-wrap w-full h-fit justify-between items-center p-5 px-4 border-t rounded-t-lg gap-3 md:flex fixed bottom-0 left-0 right-0">
