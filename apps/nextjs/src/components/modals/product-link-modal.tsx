        ...
        <BaseModal>
            ...
            <BaseModalContent>
                ...
                <BaseModalDescription>
                    You are about to leave the website. Are you sure you want to continue? This link is user-input and may contain malicious content or not be safe.
                </BaseModalDescription>
                <p className="mt-2 mb-4"><strong>Destination:</strong> {link}</p>
