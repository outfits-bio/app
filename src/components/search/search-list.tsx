...
export function SearchList() {
    ...
    const isPending = isFetching || isRefetching || isFetchingNextPage;

    return <div className="w-full md:w-5/6 lg:w-3/4 xl:w-1/2">
        <SearchBar isFetching={isPending} refetch={refetch} input={input} setInput={setInput} />
        ...
        {hasNextPage && <Button onClick={() => fetchNextPage()} centerItems variant={'ghost'} isLoading={isFetchingNextPage} className="mt-2 border border-stroke" >
            Load More
        </Button>}
    </div>
}