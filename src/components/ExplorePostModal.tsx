...
export const ExplorePostModal = ({ explorePost }: ExplorePostModalProps) => {
    ...
    const post = explorePost.find((post) => post.id === query.postId);
    ...
    return <Dialog as="div"
        ...
        className={`relative z-10 ${urbanist.variable} ${inter.variable} font-urbanist`}>
