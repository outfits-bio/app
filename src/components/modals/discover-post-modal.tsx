              ...
              >
                ...
                >
                  <Image
                    ...
                    alt={post.type ?? ""}
                    fill
                    className="rounded-xl border border-stroke object-cover"
                  />
                  {likeAnimation && (
                  ...
                  <button
                    className="absolute left-4 top-4 text-white focus:outline-none"
                    onClick={close}
                  >
                    ...
                    <div className="flex justify-between items-center w-full">
                      ...
                      >
                        <Image
                          ...
                          src={formatAvatar(post.user.image, post.user.id)}
