    ...
    <div className="flex flex-col items-start rounded-lg border border-stroke bg-white dark:bg-black dark:hidden">
      <div className="flex flex-col items-start gap-5 p-10 self-stretch">
        ...
        <div className="flex gap-2 max-w-full overflow-auto">
          <div
            className={`flex items-start gap-10 p-3 rounded-full ${theme === "light" ? "border" : ""}`}
          ...
          <div
            className={`flex items-start gap-10 p-3 rounded-full ${theme === "light-orange" ? "border" : ""}`}
          ...
          <div
            className={`flex items-start gap-10 p-3 rounded-full ${theme === "light-brown" ? "border" : ""}`}
            onClick={() => setTheme("light-brown")}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="56"
          ...
          <div
            className={`flex items-start gap-10 p-3 rounded-full ${theme === "light-hot-pink" ? "border" : ""}`}
            onClick={() => setTheme("light-hot-pink")}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="56"
          ...
          <div
            className={`flex items-start gap-10 p-3 rounded-full ${theme === "light-pink" ? "border" : ""}`}
