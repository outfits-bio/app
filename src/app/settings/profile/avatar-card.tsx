    ...
    <div className="flex flex-col items-start rounded-lg border border-stroke bg-white dark:bg-black">
      ...
      <div className="flex-wrap items-start flex gap-24 p-10 self-stretch">
        <div className="flex flex-col items-start gap-3 flex-1">
          ...
          <p>
            Take your best shot because your avatar is how you will appear on
            most of the website.
          </p>
        </div>
        <form
        ...
        >
          {sessionData ? (
            <div>
              <div
                className="rounded-full h-44 w-44 flex items-center justify-center border dark:border-stroke"
